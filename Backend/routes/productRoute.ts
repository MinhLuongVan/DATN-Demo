...
import { getAllProduct, addProduct, findIdProduct, updatePost, deletePost, getProductByNew, getProductByCategory, getProductByTree, getProductBySale, getProductByCastus, getProductByPot, getProductByStoneLotus, getProductByHangingTree, searchProduct } from '../controllers/productController';
...
export const productRoute = function (app: express.Application) {
    ...
    app.route("/apiproduct/search").post(searchProduct);
}